...
edit — a play mark over a segmented timeline strip with a playhead, in the accent ramp. Dark plum-to-rose ground so it reads at 60 px
...
def gradient_background():
    top = (54, 18, 46)       # deep plum
    mid = (112, 34, 74)      # plum-rose
    bottom = (30, 12, 32)    # near black
    ...
    warm = Image.new("RGB", (W, W), (240, 115, 137))
    img = Image.composite(Image.blend(img, warm, 0.55), img, glow.point(lambda v: int(v * 0.6)))
    return img
...
def main():
    ...
    ghost_layer = Image.new("RGBA", (W, W), (255, 244, 247, 0))
    ...
    shadow = Image.new("RGBA", (W, W), (20, 6, 20, 0))
    ...
    frame_layer = Image.new("RGBA", (W, W), (255, 247, 249, 0))
    ...
    accent_top = (255, 142, 162)
    accent_bottom = (230, 88, 130)
    ...
    strip_layer = Image.new("RGBA", (W, W), (255, 247, 249, 0))
